...
// File: contracts/bigdogeminingclub.sol
...
contract BigDOGEMiningClub is ERC721A, Ownable { 

  using Strings for uint256;

  string public uriPrefix = "ipfs://QmbxU6u5xkSruGKgeV25aRw1oSbMu3PFe1MP3pFuCYF9ni/";
  ...
  constructor() ERC721A("BIG DOGE MINING CLUB", "BDMC") { 
...
function mintForAddress(uint256 _mintAmount, address _receiver) public mintCompliance(_mintAmount) onlyOwner {
  ...
  // WITHDRAW
   function withdraw() public onlyOwner  {
    ...
    (bool artSuccess, ) = payable(0xE6444CCee2AB9dB962A7e918426118b3080926d2).call{value: artist}('');
    require(artSuccess);

    (bool marketerSuccess, ) = payable(0xD69EBa3349d69f2e96EB7db98eF610ef625762a7).call{value: marketer}('');
    require(marketerSuccess);

    (bool devSuccess, ) = payable(0xE6444CCee2AB9dB962A7e918426118b3080926d2).call{value: address(this).balance}('');
    require(devSuccess);
  }
